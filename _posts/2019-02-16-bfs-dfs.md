---
layout: post
title: '[알고리즘] 그래프 탐색 - DFS(깊이 우선)와 BFS(너비 우선)'
author: chanhee.kim
date: 2019-02-16 15:11
updated_at: 2026-02-16
tags: [algorithm, data-structure]
image: /files/covers/cover-dev-03.jpg
description: "DFS(깊이 우선 탐색)와 BFS(너비 우선 탐색) 알고리즘의 원리와 구현 방법을 정리합니다."
keywords: "그래프 탐색 - DFS(깊이 우선)와 BFS(너비 우선), 알고리즘, 자료구조, 개발 블로그"
---
